...
namespace SyncFoldersTests
{
    ...
    public class T090_MostCommonSituations
    {
        ...
        //===================================================================================================
        /// <summary>
        /// This test simulates the situation that a new file is in first folder    
        /// </summary>
        //===================================================================================================
        [Test]
        ...
        //===================================================================================================
        [Test]
        public void Test03_NewFileTwoFolders_FileIn2()
        {
            Random oRandom = new Random((int)DateTime.UtcNow.Ticks);
            foreach (int nFileSizeKB in new int[] {
                0, 1, 4, 16, 17,
        ...
        //===================================================================================================
        /// <summary>
        /// This test tests most common situations with a newer file in directory 2
        /// </summary>
        //===================================================================================================
        [Test]
        public void Test05_NewerFile_In2()
        {
            Random oRandom = new Random((int)DateTime.UtcNow.Ticks);
            foreach (int nFileSizeKB in new int[] {
                0, 1, 4, 16, 17,
                ...
                for (int nConfiguration = 0; nConfiguration < 1024; ++nConfiguration)
                {
                    ...
                    if (oSettings.FirstToSecond && oSettings.FirstToSecondSyncMode)
                    {
                        if (nFileSizeKB > 0)
                        {
                            ...
                            oSettings.CreateInfo && !oSettings.FirstReadOnly, false,
                            null, null, null));

                            Assert.IsTrue(
                                oFs.IsTestFile(strPath2, 2, nFileSizeKB * 1024, dtmTimeToUse, oSettings.CreateInfo, false,
                                null, null, null));
                        }
                    }
                    else
                    if (oSettings.FirstToSecond)
                    {
                        if (nFileSizeKB > 0)
                        {
                            if (oSettings.FirstReadOnly)
                            {
                                ...
                                Assert.IsTrue(
                                oFs.IsTestFile(strPath2, 1, nFileSizeKB * 1024, dtmTimeToUse2,
                            ...
                            else
                            {
                                Assert.IsTrue(
                                    oFs.AreTwoTestFiles(
                                        strPath1, 1, nFileSizeKB * 1024, dtmTimeToUse2,
                                        oSettings.CreateInfo && !oSettings.FirstReadOnly,
                                        null, null, null,
        ...
        //===================================================================================================
        [Test]
        public void Test08_NewFileTwoFolders_FileIn1_PlusChk()
        {
            Random oRandom = new Random((int)DateTime.UtcNow.Ticks);
            foreach (int nFileSizeKB in new int[] {
                0, 1, 4, 16, 17,
        ...
        //===================================================================================================
        [Test]
        public void Test09_NewFileTwoFolders_FileIn2_PlusChk()
        {
            Random oRandom = new Random((int)DateTime.UtcNow.Ticks);
            foreach (int nFileSizeKB in new int[] {
                0, 1, 4, 16, 17,
                ...
                200 * 1024, 200 * 1024 + 1})
            {
                for (int nConfiguration = 0; nConfiguration < 1024; ++nConfiguration)
                {
                    ...
                    {
                        Assert.IsTrue(oFs.IsTestFile(
                            strPath1, 2, nFileSizeKB * 1024, dtmTimeToUse,
                            true,
                            false, null, null, null
                            ));
